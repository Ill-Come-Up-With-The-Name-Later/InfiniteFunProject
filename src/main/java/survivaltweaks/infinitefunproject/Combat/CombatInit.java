...
import survivaltweaks.infinitefunproject.Combat.MultiHits.DealMultiHit;
...
public class CombatInit {
    ...
    public static void init() {
        ...
        Bukkit.getServer().getPluginManager().registerEvents(new DealMultiHit(), InfiniteFunProject.plugin);
    }
}
