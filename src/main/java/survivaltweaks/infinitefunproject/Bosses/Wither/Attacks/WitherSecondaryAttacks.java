...
public class WitherSecondaryAttacks implements Listener {
    ...
    /**
     * Wither spawning and attack loop
     *
    ...
    private void rallyUndead(Wither wither) {
        ...
        drawCircle(wither.getLocation(), 5, Particle.SMOKE, 90);
        drawCircle(wither.getLocation(), 5, Particle.SOUL, 90);

        for(Entity entity : entities) {
            if(entity instanceof Zombie || entity instanceof Skeleton) {
                drawCircle(entity.getLocation(), 4, Particle.SMOKE, 90);
                entity.getWorld().spawnParticle(Particle.WITCH, entity.getLocation().add(0, 0.3, 0), 50, 0.3, 0.1, 0.3, 0.04);
                entity.getWorld().spawnParticle(Particle.SMOKE, entity.getLocation().add(0, 0.3, 0), 40, 0.3, 0.1, 0.3, 0.04);
    ...
    private void lifesteal(Wither wither) {
        ...
        drawCircle(wither.getLocation(), 4, Particle.HAPPY_VILLAGER, 90);
